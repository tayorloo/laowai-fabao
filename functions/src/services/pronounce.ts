...
export function computePronunciationScore(targetText: string, recognizedText: string, confidence: number) {
  ...
  else if (score >= 70) feedback = 'Strong pronunciation with minor differences.';
  else if (score >= 50) feedback = 'Understandable, but practice tone and syllables.';
  else feedback = 'Try again. Focus on tone and clear syllables.';
